      ...
      if(isset($_POST['send'])){
         ...
         if($date==null and $topwear==null and $bottomwear==null and $woolen==null and $others==null and $servicetype == null and $name==null and $email==null and $phone==null and $address==null and $description==null)
         {
            ...
            if ($connection->query($request)) {
               $_POST = array();
               echo '<script>alert("Hurrah! your request has been submitted succesfully.");location.href="./home.php";</script>';

            } else {
            echo "Error: " . $request . "<br>" . $connection->error;
            echo '<script>alert("Sorry! your request of cleaning session is failed. Please try again. ");location.href="./book.php";</script>';
